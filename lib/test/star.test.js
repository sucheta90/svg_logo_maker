...
describe("Star", () => {
  ...
  describe("renderSvg() method", () => {
    it("Should return a string with the properties and their values", () => {
      ...
      expect(star.renderSvg()).toBe(
        `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg" ><polygon points="100,10 40,198 190,78 10,78 160,198" fill="purple"/><text x="100" y="130" font-size="40" text-anchor="middle" fill="white">Hello World</text></svg>`
      );
    });
  });
});
