  ...
  describe("renderSvg() method", () => {
    it("Should return a string with the properties and their values", () => {
      ...
      expect(circle.renderSvg()).toBe(
        `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg" ><circle cx="150" cy="100" r="80" fill="purple"/><text x="150" y="120" font-size="50" text-anchor="middle" fill="white">Hello World</text></svg>`
      );
    });
  });
});
